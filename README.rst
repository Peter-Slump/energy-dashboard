...
1. Install app::
  ...
  $ git clone git+https://github.com/peter-slump/energy-dashboard@v0.0.25
  $ docker-compose up
...
2. Install app::
  ...
  $ pip install git+https://github.com/peter-slump/energy-dashboard@v0.0.25#egg=energy-dashboard
