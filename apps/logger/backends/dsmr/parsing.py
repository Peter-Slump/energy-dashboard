...
from apps.logger.backends.dsmr.exceptions import DSMRParseError
from apps.logger.backends.dsmr.objects import MBusObject, CosemObject
...
class TelegramParser(object):
    ...
    def _find_parser(self, line_value):
    ...
    def parse_line(self, line_value):
        ...
        obis_reference, parser = self._find_parser(line_value)
