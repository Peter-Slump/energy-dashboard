...
from energy_dashboard.back_end.factories import UserFactory
from energy_dashboard.dsmr.models import DSMRPowerMeter
from energy_dashboard.dsmr.services.telegram import SPECIFICATION
from energy_dashboard.utils.mixins import MockTestCaseMixin
...
class DSMRTelegramParseTestCase(MockTestCaseMixin, TestCase):
    ...
    def test_dsmr_day_power_meters_and_gas_meter_are_created(self):
        ...
        energy_dashboard.dsmr.services.telegram.parse(
            user=self.user,
